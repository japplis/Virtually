...
class ListDemos {
    ...
    void convertDemo() {
        ...
        List<Double> prices = ListConverter.convertList(products, priceService::retreivePrice);
    ...
    void convertAllDemo() throws Exception {
        ...
        List<Double> prices = ListConverter.convertAll(products, priceService::retreivePrice);
        double totalPrice = prices.stream().mapToDouble(Double::doubleValue).sum();
        System.out.println("Total price: " + totalPrice + " in " + (System.currentTimeMillis() - start) + " ms.");
    }
    ...
    void convertAllDemoFailed() {
        ...
        assertThrows(IllegalStateException.class, () -> {
            ListConverter.convertAll(products, priceService::retreivePrice);
        });
    }
    ...
    void convertToMap() {
        List<Product> products = ShopFactory.createManyProducts(15_000);
        Map<Product, Double> productPrice = ListConverter.convertToMap(products, priceService::retreivePrice);
